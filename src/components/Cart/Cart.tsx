...
import { getCartItem } from "../../Redux/Cart/CartSlice";
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className=" alert alert-info text-center mt-3">
          Total Cart Products
          <Link className="text-success mx-2 text-decoration-none" to="/cart">
            (4)
          </Link>
        </div>
        {/* cartiterm */}
        ...
        <div className="cart-buttons d-flex align-items-center row">
          <Link to="/" className="col-md-6 text-decoration-none">
